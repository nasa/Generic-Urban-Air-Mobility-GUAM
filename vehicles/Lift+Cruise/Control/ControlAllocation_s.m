function ControlAllocation(block)
...
block.InputPort(1).Dimensions  = [11,11];
block.InputPort(1).DatatypeID  = 0;  % double
block.InputPort(1).Complexity  = 'Real';
block.InputPort(1).DirectFeedthrough = true;

block.InputPort(2).Dimensions  =  [3,11];
block.InputPort(2).DatatypeID  = 0;  % double
block.InputPort(2).Complexity  = 'Real';
block.InputPort(2).DirectFeedthrough = true;

% Override output port properties
block.OutputPort(1).Dimensions  = [11,3];
...
%% Call the control allocation algorithm
M = ControlAllocation(W,B);

%%%%% Set the outputs %%%%%
block.OutputPort(1).Data = M; 
