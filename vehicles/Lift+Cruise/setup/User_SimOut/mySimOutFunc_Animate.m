...
% This is the reduced set of output data required to use the Animate_SimOut.m file...
SimOutAbb.Time                                  = SimOut.Time;
SimOutAbb.Vehicle.PropAct.EngSpeed              = SimOut.Vehicle.PropAct.EngSpeed;
SimOutAbb.Vehicle.SurfAct.Position              = SimOut.Vehicle.SurfAct.Position;
SimOutAbb.Env.Atmosphere.Density                = SimOut.Env.Atmosphere.Density;
SimOutAbb.Vehicle.EOM.InertialData.Vel_bIi      = SimOut.Vehicle.EOM.InertialData.Vel_bIi;
SimOutAbb.Vehicle.EOM.InertialData.Q_i2b        = SimOut.Vehicle.EOM.InertialData.Q_i2b;
SimOutAbb.Vehicle.EOM.InertialData.Omeg_BIb     = SimOut.Vehicle.EOM.InertialData.Omeg_BIb;
SimOutAbb.Vehicle.EOM.InertialData.Pos_bii      = SimOut.Vehicle.EOM.InertialData.Pos_bii;
SimOutAbb.RefInputs.pos_des                     = SimOut.RefInputs.pos_des;
SimOutAbb.Vehicle.EOM.WorldRelativeData.Euler   = SimOut.Vehicle.EOM.WorldRelativeData.Euler;
